...
---
<!--
  GENERATED by scripts/build-adapters.mjs from commands/story.md for the codex harness.
...
5. **Approval** via an approval prompt: Yes / Edit / No.
...
4. **Preview** path + notes + the changed sections. **Approval** via
   an approval prompt: Yes / Edit / No.
