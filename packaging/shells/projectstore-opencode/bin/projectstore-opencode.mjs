#!/usr/bin/env node
// projectstore-opencode — the opencode distribution shell of projectstore.
...
// `--harness opencode` inserted after a verb that takes it. Every other
// argument passes through, so `projectstore-opencode <verb> …` is exactly
// `projectstore <verb> --harness opencode …` — the same preview, the
...
const SHELL = "projectstore-opencode";
