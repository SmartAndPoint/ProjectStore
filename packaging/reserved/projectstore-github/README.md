...
Anything ProjectStore does with GitHub — issue references, CI checks — ships inside `projectstore` itself. Reserved so the name cannot be taken and made to look official.
