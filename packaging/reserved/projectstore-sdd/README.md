...
Spec-driven development is a practice, not a product, and ProjectStore already ships specs as a first-class artifact kind. Reserved so the name cannot be taken and made to look official.
